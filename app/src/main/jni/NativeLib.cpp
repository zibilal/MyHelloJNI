...
JNIEXPORT jint JNICALL Java_com_zibilal_myhellojni_nativelib_NativeLib_getCpuCount(JNIEnv *env, jclass clazz) {
    return android_getCpuCount();
}

JNIEXPORT jstring JNICALL Java_com_zibilal_myhellojni_nativelib_NativeLib_getCpuFamily() {
    ...
    switch (family) {
        ...
        case ANDROID_CPU_FAMILY_MIPS_64:
